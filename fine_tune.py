...
def train(args):
  ...
  if use_stable_diffusion_format:
    ...
    text_encoder, _, unet = fine_tuning_utils.load_models_from_stable_diffusion_checkpoint_novae(
        args.v2, args.pretrained_model_name_or_path, weight_dtype, accelerator.device)
  else:
